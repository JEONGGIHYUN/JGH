...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, BatchNormalization, LSTM, Reshape
...
model.add(LSTM(units=5, input_shape=(676,20)))
model.add(Flatten())
...
#LSTM
# r2_score :  0.010101045514719575
# loss : [3.2389936447143555, 0.1890999972820282]
# acc score : 0.0459