...
from tensorflow.keras.layers import Dense, LSTM, SimpleRNN, GRU, Dropout, Conv1D
...
#2 모델구성
model = Sequential()
model.add(Conv1D(filters=10,kernel_size=3, input_shape=(3,1))) # timesteps, features
