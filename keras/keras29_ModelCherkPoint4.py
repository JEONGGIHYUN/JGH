...
#     verbose= 1,
#     save_best_only=True,
#     filepath='C:/TDS/ai5/study/_save/keras29/keras29_mcp3.hdf5'
# )
# ################
...
model = load_model('C:/TDS/ai5/study/_save/keras29/keras29_mcp3.h5')
...
print('================== 2. mcp 출력====================')
model = load_model('C:/TDS/ai5/study/_save/keras29/keras29_mcp3.hdf5')
