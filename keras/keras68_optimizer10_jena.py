...
from tensorflow.keras.layers import Dense, SimpleRNN, LSTM, GRU, Dropout, BatchNormalization,Flatten, Bidirectional, Reshape
...
x_train = x_train.reshape(336210,144*14)
x_test = x_test.reshape(84053,144*14)
x_test2 = x_test2.reshape(1,144*14)

# #2. 모델구성
model = Sequential()
# model.add(GRU(units=(64), input_shape=(144,14),return_sequences=True))
# model.add(GRU(128))
model.add(Dense(400, input_dim=(144*14)))
