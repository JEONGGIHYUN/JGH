...
#2. 모델 구성
model = Sequential()
model.add(Reshape(target_shape=(5, 2)))# 
model.add(LSTM(units=5, input_shape=(5,2)))
model.add(Dense(500,))
model.add(Dense(250,))
...
# 로스 : [0.4154481589794159, 0.8134152293205261]
# acc_score : <function accuracy_score at 0x0000011698365160>
# r2 스코어 : -0.12590016418926497
# 소요시간 : 26 초