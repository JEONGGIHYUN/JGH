...
x1_train, x1_test, x2_train, x2_test,x3_train,x3_test, y1_train, y1_test, y2_train, y2_test = train_test_split(
    x1_datasets, x2_datasets,x3_datasets, y1, y2, train_size=0.7, random_state=4,
)
...
dense1 = Dense(500, activation='relu', name='bit1')(input1)
dense2 = Dense(400, activation='relu', name='bit2')(dense1)
dense3 = Dense(300, activation='relu', name='bit3')(dense2)
dense4 = Dense(200, activation='relu', name='bit4')(dense3)
dense5 = Dense(100, activation='relu', name='bit5')(dense4)
# model1 = Model(inputs=input1, outputs=output1)

input2 = Input(shape=(3,))
dense11 = Dense(300, activation='relu', name='bit11')(input2)
dense22 = Dense(200, activation='relu', name='bit22')(dense11)
dense33 = Dense(100, activation='relu', name='bit33')(dense22)
# model2 = Model(inputs=input2, outputs=output2)

input3 = Input(shape=(4,))
dense111 = Dense(300, activation='relu', name='bit111')(input3)
dense222 = Dense(200, activation='relu', name='bit222')(dense111)
dense333 = Dense(100, activation='relu', name='bit333')(dense222)

#2-3 합하기
merge1 = Concatenate(name='mg1')([dense5,dense33,dense333])
merge2 = Dense(7, name='mg2')(merge1)
merge3 = Dense(500, name='mg3')(merge2)
merge4 = Dense(100, name='last')(merge3)

output1 = Dense(80)(merge4)
output1_2 = Dense(50)(output1)
output1_3 = Dense(40)(output1_2)
output1_4 = Dense(1)(output1)

output2 = Dense(80)(merge4)
output2_2 = Dense(80)(output2)
output2_3 = Dense(60)(output2_2)
output2_4 = Dense(1)(output2_3)


model = Model(inputs=[input1,input2,input3],outputs=[output1_4,output2_4])
# model.summary()
...
#4. 평가 예측
loss1 = model.evaluate([x1_test,x2_test,x3_test],[y1_test,y2_test])
...
results1, results2 = model.predict([x1_pred,x2_pred,x3_pred])
