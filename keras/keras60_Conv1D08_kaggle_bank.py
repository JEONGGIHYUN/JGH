...
model.add(Conv1D(filters=10,kernel_size=2,input_shape=(5,2)))
model.add(Flatten())
model.add(Dense(500))
model.add(Dense(250,))
...
# Conv1D
# 로스 : [0.5131738185882568, 0.7903092503547668]
# acc_score : <function accuracy_score at 0x0000021F457F6160>
# r2 스코어 : -0.2653275
# 소요시간 : 5 초