...
model.add(LSTM(units=5, input_shape=(50,4)))
model.add(Dense(500))
...
# submission_csv.to_csv(path + 'submission_0813_16_51.csv')
...
# LSTM
# loss : [0.31692731380462646, 0.899316668510437]
# acc score : 0.8993166666666667
# 소요시간 : 46 초