...
from tensorflow.keras.layers import Dense, Dropout, Input ,Reshape, LSTM
...
#2. 모델 구성
model = Sequential ()
model.add(Reshape(target_shape=(32, 2)))# 
model.add(LSTM(units=5, input_shape=(32,2)))
model.add(Dense(500))
model.add(Dense(250))
model.add(Dense(125))
...
# LSTM
# loss : [1.1609258651733398, 0.6155555844306946]
# acc score : 0.4288888888888889
# 소요시간 : 15 초