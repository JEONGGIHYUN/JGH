...
from tensorflow.keras.layers import Dense, Dropout, Input, LSTM, GRU, Reshape
...
model.add(Reshape(target_shape=(32, 2)))# 이미지 input_shape=(8,8,1)
...
# LSTM
# 로스 : 64.89774322509766
# r2스코어 : 0.29677112363953984
# 소요시간 : 5 초
