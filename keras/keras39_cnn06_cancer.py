...
print(x_train.shape, x_test.shape) # (483, 30) (86, 30)



x_train = x_train.reshape(483,5,6,1)
x_test = x_test.reshape(86,5,6,1)
...
model.add(Conv2D(64,kernel_size=(2,2), input_shape=(5,6,1))) 
...
# 로스 : [0.06528917700052261, 0.930232584476471]
# acc_score : 0.9302325581395349
# r2 스코어 : 0.7125721921712757
# 소요시간 : 3 초