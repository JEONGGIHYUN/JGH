...
#2. 모델 구성
model = Sequential()
model.add(Reshape(target_shape=(31,3)))
model.add(Conv1D(filters=10,kernel_size=2,input_shape=(31,3)))
model.add(Flatten())
...
# Conv1D
# r2_score :  0.3878887455050507
# loss : [0.7507464289665222, 0.7597500681877136]
# acc score : 0.7328700711053652
# 소요시간 : 5 초