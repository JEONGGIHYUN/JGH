...
# x_train, x_test, y_train, y_test = train_test_split(xy_train[0][0], xy_train[0][1], train_size=1, random_state=3)
...
np_path = 'C:/TDS/ai5/_data/catdog set/'

np.save(np_path + 'cat_dog_image1.npy', arr=xy_train[0][0])
np.save(np_path + 'cat_dog_image2.npy', arr=xy_train[0][1])
...
# print(x_train.shape,x_test.shape) # (19997, 100, 100, 3) (19997, 100, 100, 3)
# print(y_train.shape,y_test.shape) # (5000, 1) (5000, 1)
