...
#1. 데이터
path = "C:\\TDS\\ai5\\_data\\kaggle\\playground-series-s4e1\\"
...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.8, random_state=7575)
...
hist = model.fit(x_train, y_train, epochs=2680, batch_size=1000, validation_split=0.2, 
                 callbacks=[es])
end_time = time.time()
...
mission_csv.to_csv(path + "submission_0723_1200.csv")
