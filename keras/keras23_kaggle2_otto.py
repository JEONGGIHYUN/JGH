...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.7, random_state=651, shuffle=True, stratify=y)
...
submission_csv.to_csv(path + 'submission_0724_21_34.csv')
