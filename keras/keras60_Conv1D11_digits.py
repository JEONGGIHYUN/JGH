...
from tensorflow.keras.layers import Dense, Dropout, Input, Reshape, Flatten, Conv1D
...
#2. 모델 구성
model = Sequential ()
model.add(Reshape(target_shape=(16,4)))
model.add(Conv1D(filters=10,kernel_size=2,input_shape=(16,4)))
model.add(Flatten())
model.add(Dense(500))
model.add(Dense(250))
model.add(Dense(125))
...
# Conv1D
# loss : [0.3098545968532562, 0.9377777576446533]
# acc score : 0.9355555555555556
# 소요시간 : 5 초